...
public class WheelParticleHandler : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // If the car tires are screeching, then smoke will emit. If the player is braking then emit a lot of smoke.
            if (isBraking)
                particleEmissionRate = 50;
            // If the player is drifting, emit smoke based on how much the player is drifting. 
